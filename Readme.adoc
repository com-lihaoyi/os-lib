...
This will create a new zip archive at `/path/to/destination.zip` containing `file1.txt`
and everything inside folder.

===== Renaming files in the zip

You can also pass in a mapping to `os.zip`'s `sourcePaths`:

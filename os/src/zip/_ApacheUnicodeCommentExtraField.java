 ...
 *
 */
public class _ApacheUnicodeCommentExtraField extends _ApacheAbstractUnicodeExtraField {

    public static final _ApacheZipShort UCOM_ID = new _ApacheZipShort(0x6375);

    public _ApacheUnicodeCommentExtraField() {
    }
     ...
     * <code>bytes</code>.
     */
    public _ApacheUnicodeCommentExtraField(final String text, final byte[] bytes, final int off,
                                    final int len) {
     ...
     * @param bytes the bytes actually written to the archive
     */
    public _ApacheUnicodeCommentExtraField(final String comment, final byte[] bytes) {
        super(comment, bytes);
    }

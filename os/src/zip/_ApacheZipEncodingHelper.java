 ...
 */
public abstract class _ApacheZipEncodingHelper {

    /**
     * A class, which holds the high characters of a simple encoding
     * and lazily instantiates a _ApacheSimple8BitZipEncoding instance in a
     * thread-safe manner.
     */
    private static class SimpleEncodingHolder {

        private final char[] highChars;
        private _ApacheSimple8BitZipEncoding encoding;
         ...
         *
         * @see _ApacheSimple8BitZipEncoding#_ApacheSimple8BitZipEncoding(char[])
         */
        ...
        /**
         * @return The associated {@link _ApacheSimple8BitZipEncoding}, which
         *         is instantiated if not done so far.
         */
        public synchronized _ApacheSimple8BitZipEncoding getEncoding() {
            if (this.encoding == null) {
                this.encoding = new _ApacheSimple8BitZipEncoding(this.highChars);
            }
     ...
     * name of the encoding UTF-8
     */
    static final _ApacheZipEncoding UTF8_ZIP_ENCODING = new _ApacheFallbackZipEncoding(UTF8);
     ...
     */
    public static _ApacheZipEncoding getZipEncoding(final String name) {
        ...
        if (name == null) {
            return new _ApacheFallbackZipEncoding();
        }
        ...
        try {
            ...
            return new _ApacheNioZipEncoding(cs);

        } catch (final UnsupportedCharsetException e) {
            return new _ApacheFallbackZipEncoding(name);
        }
    }

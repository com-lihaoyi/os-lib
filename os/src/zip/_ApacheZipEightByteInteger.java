...
import static os._ApacheZipConstants.BYTE_MASK;
 ...
 */
public final class _ApacheZipEightByteInteger {
    ...
    public static final _ApacheZipEightByteInteger ZERO = new _ApacheZipEightByteInteger(0);

    /**
     * Create instance from a number.
     * @param value the long to store as a _ApacheZipEightByteInteger
     */
    public _ApacheZipEightByteInteger(long value) {
        this(BigInteger.valueOf(value));
    }

    /**
     * Create instance from a number.
     * @param value the BigInteger to store as a _ApacheZipEightByteInteger
     */
    public _ApacheZipEightByteInteger(BigInteger value) {
        this.value = value;
    }

    /**
     * Create instance from bytes.
     * @param bytes the bytes to store as a _ApacheZipEightByteInteger
     */
    public _ApacheZipEightByteInteger(byte[] bytes) {
        this(bytes, 0);
    }
     ...
     */
    public _ApacheZipEightByteInteger(byte[] bytes, int offset) {
        value = _ApacheZipEightByteInteger.getValue(bytes, offset);
    }
    ...
    public byte[] getBytes() {
        return _ApacheZipEightByteInteger.getBytes(value);
    }
    ...
    public boolean equals(Object o) {
        return o instanceof _ApacheZipEightByteInteger
                && value.equals(((_ApacheZipEightByteInteger) o).getValue());
    }

    /**
     * Override to make two instances with same value equal.
     * @return the hashCode of the value stored in the _ApacheZipEightByteInteger
     */
    @Override
    public int hashCode() {
    ...
    public String toString() {
        return "_ApacheZipEightByteInteger value: " + value;
    }
}

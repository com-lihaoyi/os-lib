 ...
 * @since Ant 1.9.0
 */
public class _ApacheZip64ExtendedInformationExtraField
    implements _ApacheCentralDirectoryParsingZipExtraField {

    static final _ApacheZipShort HEADER_ID = new _ApacheZipShort(0x0001);
    ...
    private _ApacheZipEightByteInteger size, compressedSize, relativeHeaderOffset;
    private _ApacheZipLong diskStart;

    /**
     * Stored in {@link #parseFromCentralDirectoryData
     * parseFromCentralDirectoryData} so it can be reused when _ApacheZipFile
     ...
     */
    public _ApacheZip64ExtendedInformationExtraField() { }
     ...
     */
    public _ApacheZip64ExtendedInformationExtraField(_ApacheZipEightByteInteger size,
                                              _ApacheZipEightByteInteger compressedSize) {
     ...
     * @param size the entry's original size
     * @param compressedSize the entry's compressed size
     * @param relativeHeaderOffset _ApacheZipEightByteInteger
     * @param diskStart _ApacheZipLong
     * @throws IllegalArgumentException if size or compressedSize is null
     */
    public _ApacheZip64ExtendedInformationExtraField(_ApacheZipEightByteInteger size,
                                              _ApacheZipEightByteInteger compressedSize,
                                              _ApacheZipEightByteInteger relativeHeaderOffset,
                                              _ApacheZipLong diskStart) {
        this.size = size;
    ...
    public _ApacheZipShort getLocalFileDataLength() {
        return new _ApacheZipShort(size != null ? 2 * DWORD : 0);
    }

    /** {@inheritDoc} */
    public _ApacheZipShort getCentralDirectoryLength() {
        return new _ApacheZipShort((size != null ? DWORD : 0)
    ...
    public void parseFromLocalFileData(byte[] buffer, int offset, int length)
        ...
        size = new _ApacheZipEightByteInteger(buffer, offset);
        offset += DWORD;
        compressedSize = new _ApacheZipEightByteInteger(buffer, offset);
        offset += DWORD;
        int remaining = length - 2 * DWORD;
        if (remaining >= DWORD) {
            relativeHeaderOffset = new _ApacheZipEightByteInteger(buffer, offset);
            offset += DWORD;
            remaining -= DWORD;
        }
        if (remaining >= WORD) {
            diskStart = new _ApacheZipLong(buffer, offset);
            offset += WORD;
            remaining -= WORD;
        }
    }
    ...
    public void parseFromCentralDirectoryData(byte[] buffer, int offset,
        ...
        if (length >= 3 * DWORD + WORD) {
            ...
            diskStart = new _ApacheZipLong(buffer, offset + length - WORD);
        }
    }
    ...
    public void reparseCentralDirectoryData(boolean hasUncompressedSize,
        ...
        if (rawCentralDirectoryData != null) {
            ...
            if (hasUncompressedSize) {
                size = new _ApacheZipEightByteInteger(rawCentralDirectoryData, offset);
                offset += DWORD;
            }
            if (hasCompressedSize) {
                compressedSize = new _ApacheZipEightByteInteger(rawCentralDirectoryData,
                                                         offset);
                offset += DWORD;
            }
            if (hasRelativeHeaderOffset) {
                relativeHeaderOffset =
                    new _ApacheZipEightByteInteger(rawCentralDirectoryData, offset);
                offset += DWORD;
            }
            if (hasDiskStart) {
                diskStart = new _ApacheZipLong(rawCentralDirectoryData, offset);
                offset += WORD;
            }
        }
    }
     ...
     *
     * @return _ApacheZipEightByteInteger
     */
    public _ApacheZipEightByteInteger getSize() {
        return size;
    }
     ...
     * The uncompressed size stored in this extra field.
     *
     * @param size _ApacheZipEightByteInteger
     */
    public void setSize(_ApacheZipEightByteInteger size) {
        this.size = size;
    }
     ...
     * @return _ApacheZipEightByteInteger
     */
    public _ApacheZipEightByteInteger getCompressedSize() {
     ...
     * The uncompressed size stored in this extra field.
     *
     * @param compressedSize _ApacheZipEightByteInteger
     */
    public void setCompressedSize(_ApacheZipEightByteInteger compressedSize) {
        this.compressedSize = compressedSize;
    }
     ...
     * @return _ApacheZipEightByteInteger
     */
    public _ApacheZipEightByteInteger getRelativeHeaderOffset() {
     ...
     * The relative header offset stored in this extra field.
     *
     * @param rho _ApacheZipEightByteInteger
     */
    public void setRelativeHeaderOffset(_ApacheZipEightByteInteger rho) {
     ...
     *
     * @return _ApacheZipLong
     */
    public _ApacheZipLong getDiskStartNumber() {
        return diskStart;
    }
     ...
     * The disk start number stored in this extra field.
     *
     * @param ds _ApacheZipLong
     */
    public void setDiskStartNumber(_ApacheZipLong ds) {
        diskStart = ds;
    }

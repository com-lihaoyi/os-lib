 ...
 */
final class _ApacheZipConstants {
    private _ApacheZipConstants() { }

    /** Masks last eight bits */
    static final int BYTE_MASK = 0xFF;

    /** length of a _ApacheZipShort in bytes */
    static final int SHORT = 2;

    /** length of a _ApacheZipLong in bytes */
    static final int WORD = 4;

    /** length of a _ApacheZipEightByteInteger in bytes */
